        ...
        btn_reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!isCheckEmptyField())
                {
                    ...
                    {
                        edt_pass.setError("Invalid Password! Password should be atleast 6 character");
                ...
                if(task.isSuccessful())
                {
                    ...
                    db.collection("users").document(user.getUid()).set(usermap).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(getActivity().getApplicationContext(),"Register Successfull",Toast.LENGTH_SHORT).show();
                        }
